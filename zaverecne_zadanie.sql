...
--
-- Hostiteľ: localhost
-- Čas generovania: Pi 18.Máj 2018, 14:54
...
INSERT INTO `TRASA` (`id`, `id_user`, `Start`, `End`, `Vzdialenost`, `Mode`) VALUES
...
INSERT INTO `USER_PATH` (`id`, `id_user`, `id_trasa`, `aktivnost`, `progres`) VALUES
(1, 1, 40, '1', 10),
(2, 2, 41, '0', 50);
